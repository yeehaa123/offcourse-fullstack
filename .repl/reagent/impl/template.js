...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__34796__auto__,writer__34797__auto__,opt__34798__auto__){
return cljs.core._write.call(null,writer__34797__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__34198__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__34198__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__34198__auto__)){
return or__34198__auto__;
} else {
...
var G__42663 = o;
(G__42663[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__42664__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__42664 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__42665__i = 0, G__42665__a = new Array(arguments.length -  0);
while (G__42665__i < G__42665__a.length) {G__42665__a[G__42665__i] = arguments[G__42665__i + 0]; ++G__42665__i;}
  args = new cljs.core.IndexedSeq(G__42665__a,0);
} 
return G__42664__delegate.call(this,args);};
G__42664.cljs$lang$maxFixedArity = 0;
G__42664.cljs$lang$applyTo = (function (arglist__42666){
var args = cljs.core.seq(arglist__42666);
return G__42664__delegate(args);
});
...
var old_42667 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_42667))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_42667)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__34186__auto__ = (node === document.activeElement);
...
if(cljs.core.truth_((function (){var and__34186__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__42670 = jsprops;
(G__42670["defaultValue"] = value);

(G__42670["onChange"] = ((function (G__42670,v,value,on_change){
return (function (p1__42668_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__42668_SHARP_);
});})(G__42670,v,value,on_change))
);
...
var vec__42672 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__42672,(0),null);
var id = cljs.core.nth.call(null,vec__42672,(1),null);
var class$ = cljs.core.nth.call(null,vec__42672,(2),null);
...
var temp__4427__auto__ = (function (){var G__42674 = cljs.core.meta.call(null,v);
var G__42674__$1 = (((G__42674 == null))?null:reagent.impl.template.get_key.call(null,G__42674));
return G__42674__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__42676_42677 = v;
var G__42676_42678__$1 = (((G__42676_42677 == null))?null:reagent.impl.template.key_from_vec.call(null,G__42676_42677));
var G__42676_42679__$2 = (((G__42676_42678__$1 == null))?null:(jsprops["key"] = G__42676_42678__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__42682 = cljs.core.meta.call(null,argv);
var G__42682__$1 = (((G__42682 == null))?null:reagent.impl.template.get_key.call(null,G__42682));
return G__42682__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__42683 = (((jsprops == null))?{}:jsprops);
(G__42683["key"] = key);
...
var G__42684 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__42684;
continue;
}
} else {
...
var n__35101__auto___42685 = a.length;
var i_42686 = (0);
while(true){
if((i_42686 < n__35101__auto___42685)){
(a[i_42686] = reagent.impl.template.as_element.call(null,(a[i_42686])));

var G__42687 = (i_42686 + (1));
i_42686 = G__42687;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__35101__auto___42688 = a.length;
var i_42689 = (0);
while(true){
if((i_42689 < n__35101__auto___42688)){
var val_42690 = (a[i_42689]);
if((cljs.core.vector_QMARK_.call(null,val_42690)) && ((reagent.impl.template.key_from_vec.call(null,val_42690) == null))){
(o["no-key"] = true);
} else {
}

(a[i_42689] = reagent.impl.template.as_element.call(null,val_42690));

var G__42691 = (i_42689 + (1));
i_42689 = G__42691;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__34186__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__34186__auto__){
return (ctx["no-key"]);
} else {
return and__34186__auto__;
...
var G__42693 = (cljs.core.count.call(null,argv) - first_child);
switch (G__42693) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__42693){
