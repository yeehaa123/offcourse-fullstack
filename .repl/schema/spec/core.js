...
var m__19822__auto__ = (schema.spec.core.subschemas[goog.typeOf(x__19821__auto__)]);
if(!((m__19822__auto__ == null))){
return m__19822__auto__.call(null,this$);
} else {
var m__19822__auto____$1 = (schema.spec.core.subschemas["_"]);
...
var x__19821__auto__ = (((this$ == null))?null:this$);
var m__19822__auto__ = (schema.spec.core.checker[goog.typeOf(x__19821__auto__)]);
if(!((m__19822__auto__ == null))){
return m__19822__auto__.call(null,this$,params);
} else {
var m__19822__auto____$1 = (schema.spec.core.checker["_"]);
if(!((m__19822__auto____$1 == null))){
return m__19822__auto____$1.call(null,this$,params);
} else {
...
}catch (e56224){if((e56224 instanceof Object)){
var e_SHARP_ = e56224;
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__56225,p__56226){
var map__56231 = p__56225;
...
var schema__$1 = cljs.core.get.call(null,map__56231__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__56231__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__56232 = p__56226;
var map__56232__$1 = ((((!((map__56232 == null)))?((((map__56232.cljs$lang$protocol_mask$partition0$ & (64))) || (map__56232.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56232):map__56232);
var params = map__56232__$1;
var subschema_checker = cljs.core.get.call(null,map__56232__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__56232__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
return schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache))
});})(map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache))
,((function (map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache){
return (function (){
var sub = subschema_checker.call(null,schema__$1,params);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache))
} else {
return sub;
}
});})(map__56231,map__56231__$1,schema__$1,error_wrap,map__56232,map__56232__$1,params,subschema_checker,cache))
